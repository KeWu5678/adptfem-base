function ax = plotRT0(meshdata, p)
%%PLOTRT0 plots the Raviart-Thomas function p on a triangulation
%given by a MeshData object
%   ax = PLOTRT0(meshdata, p)
...
%
    ...
    p4e = p(meshdata.ed4e);
    prefactors4e = ...
        bsxfun(@rdivide, meshdata.sign4e .* meshdata.length4ed(meshdata.ed4e), meshdata.area4e);
    c4e = meshdata.c4e;
    coefficients4e = ...
    ...
    % Set titles of plot
    title(ax, {'RT0 plot'; [num2str(meshdata.nElem), ' elements']});
end
