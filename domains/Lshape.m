function [c4n, n4e, onDirichlet, onNeumann, normal] = Lshape(reflected)
%%LSHAPE provides geometric information of L-shaped domain.
...
%   [c4n, n4e, onDirichlet, onNeumann, normal] = LSHAPE(reflected)
...
%closure of the domain Omega
    ...
    normal(near(x(:,1), 1),1) = 1;
    normal(near(x(:,2), 1),2) = 1;
    normal(near(x(:,1), 0) & nearorgreater(x(:,1), 0), 1) = 1;
